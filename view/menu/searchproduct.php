<script>
    ...
    window.onload = function () { //cấu trúc dc tạo khi bắt đầu
        if (isLocalStorageSupported()) {
            var clickedCategory = localStorage.getItem("clickedCategory"); //localStorage hỗ trợ lưu clickedcategory
            if (clickedCategory) {
                var elements = document.getElementsByClassName("category__item"); //lấy all phần tử
                for (var i = 0; i < elements.length; i++) {
                    if (elements[i].textContent === clickedCategory) {
                        elements[i].classList.add("clicked"); // trùng
                    ...
                    <ul class="category__list">
                        ...
                        while ($row_category = mysqli_fetch_array($query_lietke_danhmucsp)) {
                            ...
                            <a class="category__item-link"
                                ...
                                <!-- thay đổi id khi click category -->
                            </a>
                            <?php
                        }
                        ?>
            ...
            <div class="grid__column-10 mt-12">
                ...
                <div class="grid__row">
                    ...
                    if (isset($_GET['search'])) {
                        $searchInput = mysqli_real_escape_string($mysqli, $_GET['nameproduct']);
                        $sql_product = "SELECT * FROM tbl_product,tbl_category  WHERE tbl_product.id_category = tbl_category.id_category AND tbl_product.nameproduct like '%$searchInput%'";
